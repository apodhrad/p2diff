...
public class DiffManagerTest {
	...
	public void general() throws IOException, Exception {
		...
		// File zip2 =
		// jdm.download("http://java-sourcecode.weebly.com/uploads/7/3/2/6/7326864/library_ma218756952010.zip",
		// new File("target/beta"), true);
		// File zip1 =
		// jdm.download("http://java-sourcecode.weebly.com/uploads/7/3/2/6/7326864/memory_mon2191991142010.zip",
		// new File("target/final"), true);
